...
REF_BAM="$REF_NAME_R$READ_LEN-w$SLIDING_WIN.bam"
REF_TXT="$REF_NAME_R$READ_LEN-w$SLIDING_WIN.txt"
CAT="$REF_NAME+$SPIKE_NAME.fa"
CAT_BAM="$REF_NAME+$SPIKE_NAME_R$READ_LEN-w$SLIDING_WIN.bam"
CAT_TXT="$REF_NAME+$SPIKE_NAME_R$READ_LEN-w$SLIDING_WIN.txt"
